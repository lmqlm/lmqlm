...
(function configureEvergage() {
    try {
       Evergage.configure({
           account: "frontiersmediasa",
           dataset: "engage",
           cdnUrl: "https://cdn.evergage.com",
           trackerUrl: "https://frontiersmediasa.germany-2.evergage.com",
           siteConfigVersion: "58"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"CHF","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["currentCerberusId","customerId","emailAddress","loopId","profileId","sfCrmContactId","sfCrmLeadId","sfmcContactId","sfmcContactKey"],"lastModified":1690895988979,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":true,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
...
Evergage.init({
    ...
    const coreSiteConfig = {
        global: {
            onActionEvent: (actionEvent) => {
                ...
                if (hasConsent) {
                    ...
                    actionEvent.user.attributes.functionalCookieConsent = hasConsent;
                    const email = Evergage.cashDom(".Ibar__user__email").text().trim();
                    let emailShadow;
                    if (document.querySelector("frontiers-ibar")) {
                        if(document.querySelector("frontiers-ibar").shadowRoot){
                            if (document.querySelector("frontiers-ibar").shadowRoot.querySelector(".Ibar__user__email")) {
                                emailShadow = document.querySelector("frontiers-ibar").shadowRoot.querySelector(".Ibar__user__email").innerHTML.trim();
                            }
                        } 
                    }
                    if (email) {
                        ...
                        actionEvent.user.attributes.emailAddress = emailShadow;
                    }
                    const cerberus = getCookie("Cerberus");
                    if (cerberus) {
                        actionEvent.user.attributes.currentCerberusId = cerberus;
                    }
                }
                return actionEvent;
            },
            listeners: [
                Evergage.listener("click", "button[data-event=newsletter-btn-subscribe]", () => {
                    Evergage.sendEvent({
        ...
        pageTypes: [
            {
                name: "home",
                isMatch: () => window.location.href === "www.frontiersin.org"
                    || window.location.href === "www.frontiersin.org/"
                    || window.location.href === "https://www.frontiersin.org"
                    || window.location.href === "https://www.frontiersin.org/"
                    || /frontiersin.org\/\?/.test(window.location.href),
                action: "View Homepage Frontiers",
            },
            {
                name: "login_register",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && (/\/people\/login/.test(window.location.href)
                        || /\/register/.test(window.location.href)),
                action: "View Login/Register Frontiers",
                listeners: [
                    Evergage.listener("click", "a[data-test-id=login-with-facebook]", () => {
                        Evergage.sendEvent({
                            action: "Login"
                        });
                    }),
                    Evergage.listener("click", "a[data-test-id=login-with-linkedIn]", () => {
                        Evergage.sendEvent({
                            action: "Login"
                        });
                    }),
                    Evergage.listener("click", "a[data-test-id=login-with-twitter]", () => {
                        Evergage.sendEvent({
                            action: "Login"
                        });
                    }),
                    Evergage.listener("click", "a[data-test-id=login-with-yourmembership]", () => {
                        Evergage.sendEvent({
                            action: "Login"
                        });
                    }),
                    Evergage.listener("click", "#loginButton", () => {
                        const hasConsent = checkConsent();
                        const loginEmail = Evergage.cashDom("#login-email").val();
                        if (hasConsent && loginEmail) {
                            Evergage.sendEvent({
                                action: "Login",
                                user: {
                                    attributes: {
                    ...
                    Evergage.listener("click", "div.account-btns-container.four-items", () => {
                        Evergage.sendEvent({
                            action: "Register"
                        });
                    }),
                    Evergage.listener("click", "#register-01 a.btn.primary", () => {
                        const hasConsent = checkConsent();
                        const agreeTerms = Evergage.cashDom("label.custom-checkbox-item[for=agreeTerms]").attr("class");
                        const registerFirstName = Evergage.cashDom("#register-01-firstname").val();
                        const registerLastName = Evergage.cashDom("#register-01-lastname").val();
                        const registerEmail = Evergage.cashDom("#register-01-email").val();
                        if (hasConsent && agreeTerms === "custom-checkbox-item checked" && registerFirstName && registerLastName && registerEmail) {
                            Evergage.sendEvent({
                                action: "Register",
                                user: {
                                    attributes: {
            ...
            {
                name: "about_research_topic",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /https:\/\/www.frontiersin\.org\/about\/research-topics([^\/?#]*)/.test(window.location.href),
                action: "View Main About Research Topic Page"
            },
            {
                name: "about_national_consortia",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /https:\/\/www.frontiersin\.org\/about\/national-consortia([^\/?#]*)/.test(window.location.href),
                action: "View Main About National Consortia Page"
            },
            {
                name: "about_collaborators",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /https:\/\/www.frontiersin\.org\/about\/collaborators([^\/?#]*)/.test(window.location.href),
                action: "View Main About Collaborators Page"
            },
            {
                name: "about_institutional_partnerships",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /https:\/\/www.frontiersin\.org\/about\/institutional-partnerships([^\/?#]*)/.test(window.location.href),
                action: "View Main About Institutional Partnerships Page"
            },
            {
                name: "about_fee_policy",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /https:\/\/www.frontiersin\.org\/about\/fee-policy([^\/?#]*)/.test(window.location.href),
                action: "View Main Fee Policy Page"
            },
            {
                name: "section",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /\/journals\//.test(window.location.href)
                    && /\/sections\//.test(window.location.href)
                    && !(/\/research-topics/.test(window.location.href)),
                action: "View Section Page",
                catalog: {
                    Section: {
                        _id: () => {
                            let href = window.location.href.split("/");
                            let rank = href.indexOf("sections") + 1;
                            let id = href[rank].split("?")[0].split("#")[0];
                            return id;
                        },
                        ...
                        imageUrl: Evergage.resolvers.fromMeta("image"),
                        relatedCatalogObjects: {
                            Journal: getJsonLdIsPartOfElement("journals"),
                            ItemClass: getJsonLdIsPartOfElement("journals"),
                        },
                    }
                },
            },
            {
                name: "journal_search_articles",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /https:\/\/www.frontiersin\.org\/journals\/([^\/?#]*)/.test(window.location.href)
                    && (/\/articles/.test(window.location.href))
                    && !(/\/sections/.test(window.location.href))
                    && !(/\/research-topics/.test(window.location.href))
                    && !(/\/editors/.test(window.location.href))
                    && !(/\/about/.test(window.location.href))
                    && !(/\/for-authors/.test(window.location.href))
                    && !(/\/volumes/.test(window.location.href)),
                action: "View Search Articles in Journal Page",
                catalog: {
                    Journal: {
                        _id: () => {
                            let href = window.location.href;
                            let regex = /https:\/\/www.frontiersin\.org\/journals\/([^\/?#]*)/;
                            let id = href.match(regex)[1];
                            return id;
                        },
                        name: Evergage.resolvers.fromMeta("title", (ele) => {
                            return ele.split("|")[0].trim();
                        }),
                        description: Evergage.resolvers.fromMeta("description"),
                        url: () => {
                            let href = window.location.href;
                            let regex = /https:\/\/www.frontiersin\.org\/journals\/[^\/?#]*/;
                            let url = href.match(regex)[0];
                            return url;
                        },
                        imageUrl: Evergage.resolvers.fromMeta("image"),
                    }
            ...
            {
                name: "journal_editorial_guidelines",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^\/journals\/([a-zA-Z\-]+)\/for-authors\/editor-guidelines(([\?\#].*)?)$/.test(window.location.pathname),
                action: "View Journal Editorial Guidelines",
                catalog: {
                    Journal: {
                        _id: () => {
                            let href = window.location.pathname;
                            let regex = /\/journals\/([a-zA-Z\-]+)\/for-authors\/editor-guidelines(([\?\#].*)?)$/;
                            let id = href.match(regex)[1];
                            return id;
                        },
                        name: Evergage.resolvers.fromMeta("title"),
                        description: Evergage.resolvers.fromMeta("description"),
                        url: () => {
                            return window.location.origin + window.location.pathname;
                        },
            ...
            {
                name: "journal_publishing_fee",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^\/journals\/([a-zA-Z\-]+)\/for-authors\/publishing-fees(([\?\#].*)?)$/.test(window.location.pathname),
                action: "View Journal Publishing Fee",
                catalog: {
                    Journal: {
                        _id: () => {
                            let href = window.location.pathname;
                            let regex = /\/journals\/([a-zA-Z\-]+)\/for-authors\/publishing-fees(([\?\#].*)?)$/;
                            let id = href.match(regex)[1];
                            return id;
                        },
                        name: Evergage.resolvers.fromMeta("title"),
            ...
            },
            {
                name: "journal",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^https:\/\/www\.frontiersin\.org\/journals\/([a-zA-Z\-]+)(([\?\#].*)?)$/.test(window.location.href),
                action: "View Journal Page",
                catalog: {
                    Journal: {
                        _id: () => {
                            let href = window.location.href;
                            let regex = /^https:\/\/www\.frontiersin\.org\/journals\/([a-zA-Z\-]+)(([\?\#].*)?)$/;
                            let id = href.match(regex)[1];
                            return id;
                        },
                        name: Evergage.resolvers.fromMeta("title"),
                        ...
                        imageUrl: Evergage.resolvers.fromMeta("image"),
                        impactFactor: Evergage.resolvers.fromSelector("a[data-event='metrics-a-impactFactor'] .Metrics__numbers__main"),
                        citeScore: Evergage.resolvers.fromSelector("a[data-event='metrics-a-citeScore'] .Metrics__numbers__main"),
                        citations: Evergage.resolvers.fromSelector(
                            "a[data-event='metrics-a-citations'] .Metrics__numbers__main",
                            (cit) => cit.replace(',', '')),
                    }
                },
            },
            {
                ...
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /\/articles\//.test(window.location.href),
                action: "View Article Page",
                catalog: {
                    Article: {
                        _id: () => {
                            if (document.head.querySelector("meta[name=citation_doi]")){
                                return document.head.querySelector("meta[name=citation_doi]").content;
                            } else {
                                let href = window.location.href.split("/");
                                let rank1 = href.indexOf("articles") + 1;
                                let rank2 = href.indexOf("articles") + 2;
                                let id = href[rank1] + '/' + href[rank2];
                                return id; 
                            }
                        },
                        name: () => {
                            if (document.head.querySelector("meta[name=Title]")) {
                                return document.head.querySelector("meta[name=Title]").content;
                            } else if (getDataFromDataLayer("view_article","article_title")) {
                                return getDataFromDataLayer("view_article","article_title");
                            } else if (document.querySelector("main.ErrorPage")) {
                                return "Article Page Error";
                            }
                        },
                        imageUrl: () => {
                            if (document.querySelector("main.ErrorPage")) {
                                return "";
                            } else {
                        ...
                        articleType: Evergage.resolvers.fromSelector(".article-header-container .header-bar-one h2"),
                        dateAccepted: Evergage.resolvers.fromMeta("citation_online_date"),
                        datePublished: Evergage.resolvers.fromMeta("citation_publication_date"),
                        views: Evergage.resolvers.fromSelector(
                            ".title-number",
                            (cit) => cit.replace(',', '')
                        ),
                        categories: () => {
                            let journal = getJsonLdIsPartOfElementForArticles("journals")[0];
                            let section = getJsonLdIsPartOfElementForArticles("sections")[0];
                            let researchTopic = getJsonLdIsPartOfElementForArticles("research-topics")[0];
                            let categoryIdForArticle = journal;
                            categoryIdForArticle += section ? '|' + section : '';
                            categoryIdForArticle += researchTopic ? '|' + researchTopic : '';
                            return [categoryIdForArticle];
                        },
                        relatedCatalogObjects: {
                            Journal: getJsonLdIsPartOfElementForArticles("journals"),
                            Section: getJsonLdIsPartOfElementForArticles("sections"),
                            ResearchTopic: getJsonLdIsPartOfElementForArticles("research-topics"),
                            Keyword: Evergage.resolvers.fromMeta("citation_keywords", (ele) => {
                                return ele ? ele.split(';') : null;
                            }),
                            Author: () => {
                                let authorArray = new Array();
                                let authorMetaArray = document.head.querySelectorAll("meta[name=citation_author]");
                                for (let i = 0; i < authorMetaArray.length ; i++) {
                                    let authorContent = authorMetaArray[i].content;
                                    authorArray.push(authorContent);
                                }
                                return authorArray;
                            },
                            ItemClass: getJsonLdIsPartOfElementForArticles("journals"),
                            Brand: getJsonLdIsPartOfElementForArticles("sections"),
                            Style: Evergage.resolvers.fromMeta("citation_keywords", (ele) => {
                                return ele ? ele.split(';') : null;
                            }),
                        },
                    }
                ...
                listeners: [
                    Evergage.listener("click", "a.download-files-pdf", () => {
                        Evergage.sendEvent({
                            action: "Download Article"
                        });
                    }),
                    Evergage.listener("click", "a.download-files-readcube", () => {
                        Evergage.sendEvent({
                            action: "Download Article"
                        });
                    }),
                    Evergage.listener("click", "a.download-files-epub", () => {
                        Evergage.sendEvent({
                            action: "Download Article"
                        });
                    }),
                    Evergage.listener("click", "a.download-files-nlm", () => {
                        Evergage.sendEvent({
                            action: "Download Article"
                        });
                    }),
                    Evergage.listener("click", "#floating-download-pdf-btn", () => {
                        Evergage.sendEvent({
                            action: "Download Article"
                        });
                    }),
            ...
            },
            {
                name: "research_topic",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^https:\/\/www\.frontiersin\.org\/research-topics\/[\d]*\/([a-zA-Z\-]+)(([\?\#].*)?)$/.test(window.location.href),
                action: () => {
                    let actionName = "View Closed Research Topic Page";
                    let participate = document.querySelector("a[data-event=subscribetothistopic-link-click]");
                    if (participate) {
                        actionName = "View Open Research Topic Page";
                    }
                    return actionName;
                },
                catalog: {
                    ResearchTopic: {
                        _id: () => {
                            let href = window.location.href;
                            let regex = /https:\/\/www.frontiersin\.org\/research-topics\/\d*\/([^\/?#]*)/;
                            let id = href.match(regex)[1];
                            return id;
                        },
                        name: () => {
                            if (document.head.querySelector("meta[name=Title]")) {
                                ...
                                return getDataFromDataLayer("view_research_topic", "research_topic_title");
                            }
                        },
                        url: () => {
                            let href = window.location.href;
                            let regex = /https:\/\/www.frontiersin\.org\/research-topics\/\d*\/([^\/?#]*)/;
                            let id = href.match(regex)[0];
                            return id;
                        },
                        views: Evergage.resolvers.fromSelector(
                            "#header-impact-count",
                        ...
                        downloads: Evergage.resolvers.fromSelector(
                        ...
                        relatedCatalogObjects: {
                            Section: getJsonLdIsPartOfElement("sections"),
                            Journal: getJsonLdIsPartOfElement("journals"),
                            Brand: getJsonLdIsPartOfElement("sections"),
                            ItemClass: getJsonLdIsPartOfElement("journals"),
                        }
                    }
                },
                listeners: [
                    Evergage.listener("click", "button.MainHeader__link.e-book", () => {
                        Evergage.sendEvent({
            ...
            {
                name: "research_topic_mag",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^https:\/\/www\.frontiersin\.org\/research-topics\/[\d]*\/([a-zA-Z\-]+)\/mag(([\?\#].*)?)$/.test(window.location.href),
                action: "View Research Topic Mag Page",
                catalog: {
                    ResearchTopic: {
                        _id: () => {
                            let href = window.location.href;
                        ...
                        url: () => {
                            let href = window.location.href;
                            let regex = /^https:\/\/www\.frontiersin\.org\/research-topics\/[\d]*\/[a-zA-Z\-]+\/mag(([\?\#].*)?)$/;
                            let id = href.match(regex)[0];
                            return id;
                        },
                        views: () => {
                            let views = document.querySelectorAll("div.text-lg.font-bold.leading-none")[0].innerHTML;
                            let viewsFormat = stringToNum(views);
                            return viewsFormat;
                        },
                        isRTOpen: () => {
                            let isRTOpen = false;
                        ...
                        nbArticles: () => {
                            let nbArticles = document.querySelectorAll("div.text-lg.font-bold.leading-none")[1].innerHTML;
                            let nbArticlesFormat = stringToNum(nbArticles);
                            return nbArticlesFormat;
                        },
                        nbAuthors: () => {
                            let nbAuthors = document.querySelectorAll("div.text-lg.font-bold.leading-none")[2].innerHTML;
                            let nbAuthorsFormat = stringToNum(nbAuthors);
                            return nbAuthorsFormat;
                        },
                        relatedCatalogObjects: {
                            Section: () => {
                                var section = document.querySelector("a.breadcrumb_breadcrumb-item__pu3cE[data-gtmaction=RT_COVER_SECTION]").href.split('/').slice(-1);
                                return section;
                            },
                            Journal: () => {
                                var journal = document.querySelector("a.breadcrumb_breadcrumb-item__pu3cE[data-gtmaction=RT_COVER_JOURNAL]").href.split('/').slice(-1);
                                return journal;
                            },
                            Brand: () => {
                                var section = document.querySelector("a.breadcrumb_breadcrumb-item__pu3cE[data-gtmaction=RT_COVER_SECTION]").href.split('/').slice(-1);
                ...
                listeners: [
                    Evergage.listener("click", "a.download_downloadLink__HmHPX", () => {
                        Evergage.sendEvent({
                            action: "Download E-Book"
                        });
                    }),
                    Evergage.listener("click", "h1 + div > div > div > div > button[data-gtmaction='RT_COVER_DOWNLOAD_TOGGLE']", () => {
                        Evergage.sendEvent({
                            action: "Download E-Book"
                        });
                    }),
            ...
            },
            {
                name: "submit_article",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /\/submission\/submit/.test(window.location.href),
                action: "View Article Submit Page",
                listeners: [
                    Evergage.listener("click", "div[data-test-id=btnFinalSubmit]", () => {
                        Evergage.sendEvent({
            ...
            },
            {
                ...
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /\/guidelines\//.test(window.location.href)
                    && /\/author-guidelines/.test(window.location.href),
                action: "View Author Guidelines Page"

            },
            {
                name: "author-guidelines-journal",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /^\/journals\/([a-zA-Z\-]+)\/for-authors\/author-guidelines(([\?\#].*)?)$/.test(window.location.pathname),
                action: "View Journal Author Guidelines Page"
            ...
            },
            {
                ...
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && /\/journals\//.test(window.location.href)
                    && /\/editors/.test(window.location.href),
                action: "View Editorial Board Page"
            },
            {
                name: "editorial_board_application",
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    && window.location.pathname === "/editors/join-as-editor",
                action: "View Editorial Board Application Page",
                listeners: [
                    Evergage.listener("click", "button[data-event=btn-action]", () => {
                        let firstName = document.querySelector("#firstName").value;
                        let lastName = document.querySelector("#lastName").value;
                        let email = document.querySelector("#email").value;
                        let affiliation = document.querySelector("#UgaritInput").value;
                        let country = document.querySelector("div[describedby=field-3-error]>button div.DropDown__selectedValue").innerHTML;
                        let journal = document.querySelector("div[describedby=field-6-error]>button div.DropDown__selectedValue").innerHTML;
                        if (firstName && lastName && email && affiliation && country && journal){
                            Evergage.sendEvent({
                                action: "Submit Editorial Application",
                            })
                        }
                    })
                ]
            },
            {
                ...
                isMatch: () => window.location.hostname === "www.frontiersin.org"
                    ...
                    && /\/about/.test(window.location.href)
                    && (
                        /\/systems-biology\//.test(window.location.href)
                        || /\/stroke\//.test(window.location.href)
                        || /\/cognition\//.test(window.location.href)
                        || /\/dementia\//.test(window.location.href)
                        || /\/language-sciences\//.test(window.location.href)
                        || /\/clinical-diabetes-and-healthcare\//.test(window.location.href)
                        || /\/research-metrics-and-analytics\//.test(window.location.href)
                        || /\/toxicology\//.test(window.location.href)
                        || /\/applied-mathematics-and-statistics\//.test(window.location.href)
                        || /\/agronomy\//.test(window.location.href)
                        || /\/medicine\//.test(window.location.href)
                        || /\/communication\//.test(window.location.href)
                        || /\/bioinformatics\//.test(window.location.href)
                        || /\/ecology-and-evolution\//.test(window.location.href)
                        || /\/veterinary-science\//.test(window.location.href)
                        || /\/drug-discovery\//.test(window.location.href)
                        || /\/molecular-biosciences\//.test(window.location.href)
                        || /\/bioengineering-and-biotechnology\//.test(window.location.href)
                        || /\/environmental-science\//.test(window.location.href)
                        || /\/aging-neuroscience\//.test(window.location.href)
                        || /\/fungal-biology\//.test(window.location.href)
                    ),
                action: "View Journal Internal Info Page"
            }
        ]
    };
    ...
    let rtmSiteConfig = {
        ...
        pageTypes: [
            {
                name: "homepage",
                isMatch: () => window.location.hostname === "research-topic-management-app.frontiersin.org",
                action: "View RTM Home Page"
            },
        ]
    }
    ...
    let rtsSiteConfig = {
        ...
        pageTypes: [
            {
                name: "homepage",
                isMatch: () => window.location.hostname === "researchtopics.frontiersin.org"
                    && window.location.pathname === "/",
                action: "View RT Submission Home Page",
                listeners: [
                    Evergage.listener("click", "input.FrontiersButton", () => {
                        let firstName = document.querySelector("#first_name").value;
                        let lastName = document.querySelector("#last_name").value;
                        let email = document.querySelector("#email").value;
                        let affiliation = document.querySelector("#company").value;
                        let jobTitle = document.querySelector("[id='00N4K00000AVIIZ']").value;
                        let phd = false;
                        let phdArray = document.querySelectorAll("[id='00N4K00000D8jAp']");
                        for (i in phdArray) {
                            if (phdArray[i].value === 'Yes') {
                                phd = true;
                                break;
                            }
                        }
                        let rtIdea = document.querySelector("textarea[name='description']").value;
                        let field = document.querySelector("[id='00N4H00000EJnqG']").value;
                        let previousRT = false;
                        let previousRTArray = document.querySelectorAll("[id='00N4K00000D8jAq']");
                        for (j in previousRTArray) {
                            if (previousRTArray[j].value === 'Yes') {
                                previousRT = true;
                                break;
                            }
                        }
                        if (firstName && lastName && email && affiliation && jobTitle && phd && rtIdea && field && previousRT){
                            Evergage.sendEvent({
                                action: "Submit RT Form",
                            })
                        }
                    })
                ]
    ...
    if (currentCookieDomain === "www.frontiersin.org") {
        Evergage.initSitemap(coreSiteConfig);
    } else if (currentCookieDomain === "research-topic-management-app.frontiersin.org") {
        Evergage.initSitemap(rtmSiteConfig);
    } else if (currentCookieDomain === "researchtopics.frontiersin.org") {
        Evergage.initSitemap(rtsSiteConfig);
    }
});
...
function checkConsent() {
    ...
    let consentCheck = consentCookie.indexOf("C0003:1");
    if (consentCheck > 0) {
        hasConsent = true;
    }
    return hasConsent;
...
function getDataFromDataLayer(viewType,data) {
    if (window.dataLayer) {
        for (let i = 0; i < window.dataLayer.length; i++) {
            if (window.dataLayer[i].event && window.dataLayer[i].event == viewType) {
                return window.dataLayer[i][data];
            }
        }
    } else {
        return null;
...
function getJsonLdIsPartOfElement(element){
    let jsonLdArray = new Array();
    if (document.querySelector("script[type='application/ld+json']")){
        let jsonLd = JSON.parse(document.querySelector("script[type='application/ld+json']").innerHTML);
        let partOfArray = jsonLd.isPartOf;
        if (partOfArray){
            let partOfArrayLength = partOfArray.length;
            if (partOfArrayLength) {
                for (let i = 0; i < partOfArrayLength ; i++){
                    let part = partOfArray[i]["@id"].split("/");
                    let id = part.indexOf(element) + 1;
                    if (id > 1 ){
                        jsonLdArray.push(part[id]);
                    }
                }
            } else {
                let part = partOfArray["@id"].split("/");
                let id = part.indexOf(element) + 1;
                if (id > 1 ){
                    jsonLdArray.push(part[id]);
                }
...
function getJsonLdIsPartOfElementForArticles(element){
    let jsonLdArray = new Array();
    if (document.querySelector("script[type='application/ld+json']")){
        let jsonLd = JSON.parse(document.querySelector("script[type='application/ld+json']").innerHTML);
        let partOfArray = jsonLd.isPartOf;
        if (partOfArray) {
            let partOfArrayLength = partOfArray.length;
            if (partOfArrayLength) {
                let i = element === "research-topics" ? 2 : (element === "sections" ? 1 : 0);
                let rank = element === "research-topics" ? 2 : 1;
                if (partOfArray[i]){
                    let part = partOfArray[i]["@id"].split("/");
                    let id = part.indexOf(element) + rank;
                    if (id > 1 ){
                        jsonLdArray.push(part[id]);
                    }
                }
        ...
        switch (element){
            case 'journals': 
                elementType = 'journal_title';
                break;
            case 'sections':
                elementType = 'section_title';
                break;
            case 'research-topics':
                elementType = 'research_topic_title';
                break;
        }
        if (getDataFromDataLayer("view_article", elementType)){
            let data = getDataFromDataLayer("view_article", elementType).toLowerCase().replaceAll(" ", "-");
...
function stringToNum(s) {
    ...
    var lastCharacter = s.charAt(s.length-1).toLowerCase();
    if (multipliers[lastCharacter] != null){
        s = parseFloat(s)*multipliers[lastCharacter]
    }
    return s;
}
} catch (e) {
